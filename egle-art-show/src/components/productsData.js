const products = [
    ...
    { id: 22, name: 'Soul integration', price: 120, description: 'Size: 50*40cm' },
    {
      ...
      "name": "Mintys",
      "price": 120,
      "size": "Size: 30\"24*1.5cm",
      "description": "The forest of thoughts.. La forêt des pensées..\n“You are what you think. Your emotions are a slave to your thoughts, and you are a slave to your emotions.” (ELIZABETH GILBERT)"
    },
    { id: 24, name: 'Indian summer', price: 120, description: 'Size: 50*70*1.5cm' },
    { id: 25, name: 'The beginning of infinity', price: 120, description: 'Size: 40*30*1.5cm' },
    { id: 26, name: 'Dance of the fairies', price: 120, description: 'Size: 30*24*1.5cm' },
    { id: 27, name: 'AU FOND', price: 120, description: 'Size: 50*60cm' },
